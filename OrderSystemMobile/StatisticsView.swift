...
struct StatisticsView: View {
    @StateObject private var networkStatisticsManager = NetworkStatisticsManager()
            ...
            VStack {
                if networkStatisticsManager.statisticsJson.isEmpty {
                    Text("正在加载...")
                        ...
                        .onAppear {
                            networkStatisticsManager.fetchStatisticsJson()
                        }
                } else {
                    // 显示收入仪表盘和订单仪表盘
...
struct IncomeDashBoard: View {
    var networkStatisticsManager: NetworkStatisticsManager
